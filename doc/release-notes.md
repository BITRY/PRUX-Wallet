...
To receive security and update notifications, please watch reddit or Twitter:
  ...
  * https://www.reddit.com/r/prux/
  * @PruxC on Twitter for high priority announcements
  * @PruxC\_devs on Twitter for updates on development work
...
Prux Core is extensively tested on Ubuntu Server LTS, Mac OS X and Windows 10.
...
Prux Core should also work on most other Unix-like systems but is not
...
Block download timeouts are expressed as a multiple of block interval, and as such Prux block download times were relatively aggressive, leading to a high number of timeouts. Increased the timeouts to be more flexible to real world conditions.
...
* Return unspents greater or equal than a specific amount in PRUX: minimumAmount (default = 0).
* Return unspents lower or equal than a specific amount in PRUX: maximumAmount (default=unlimited).
* Return unspents with a total number lower or equal than a specific number: maximumCount (default=0=unlimited).
* Return unspents which total is greater or equal than a specific amount in PRUX: minimumSumAmount (default=unlimited).
